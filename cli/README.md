...
Mint Club asks you to sign an authorization identifying mint.club, the metadata action, the chain, the token, and your wallet, with a ten-minute expiry. Review those details before signing; request a fresh signature if a metadata save is retried after expiry.
